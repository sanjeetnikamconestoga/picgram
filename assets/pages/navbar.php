    ...
    <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
        <div class="d-flex justify-content-between col-lg-8 col-sm-12">
            <a class="navbar-brand" href="?">
                <img src="assets/images/picgram.png" alt="" height="28">
            </a>
            <!-- // test -->
        ...
        <ul class="navbar-nav flex-fill flex-row justify-content-evenly mb-lg-1 mb-sm-0">
            ...
            <!-- Static Notifications Link (No dynamic count) -->
            <li class="nav-item">
                <a class="nav-link text-dark" href="#notification_sidebar" data-bs-toggle="offcanvas" role="button" aria-controls="offcanvasExample"><i class="bi bi-bell-fill"></i></a>
            </li>

            <!-- Static Messages Link (No dynamic count) -->
            <li class="nav-item">
                <a class="nav-link text-dark" href="#message_sidebar" data-bs-toggle="offcanvas" role="button" aria-controls="offcanvasExample"><i class="bi bi-chat-right-dots-fill"></i></a>
            </li>
