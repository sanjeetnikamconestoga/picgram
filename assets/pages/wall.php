        ...
        <div class="card mt-4">
            <div class="card-title d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center p-2">
                    ...
                    &nbsp;&nbsp;<a href="#" class="text-decoration-none text-dark">Testuser post</a>
                </div>
                <div class="p-2">
                    <div class="dropdown">
            ...
            <div class="card-body">
                <p>This is an example post text for demonstration purposes.</p>
            </div>
    ...
    <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 p-sm-0 p-md-3">
        <div class="d-flex align-items-center p-2">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-center p-2">
                    <div><img src="assets/images/profile/suggested_user1.jpg" alt="" height="40" width="40" class="rounded-circle border"></div>
                    <div>&nbsp;&nbsp;</div>
                    <div class="d-flex flex-column justify-content-center">
                        <a href="#" class="text-decoration-none text-dark"><h6 style="margin: 0px;font-size: small;">Suggested User</h6></a>
                        <p style="margin:0px;font-size:small" class="text-muted">@suggesteduser</p>
                    </div>
                </div>
